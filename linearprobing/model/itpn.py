...
class itpn(torch.nn.Module):
    def __init__(self, modality='RGB', num_classes=10):
        super().__init__()
        
        self.modality = modality
        
        self.backbone = itpn_base_dual(modality='RGB' if modality == 'RGB' else 'SAR', num_classes=0)
        checkpoint_path = r'G:\project\itpn\output\INP_dec8share_dino_pixC_CA_800E/checkpoint-800.pth'
